...
\begin{center}
    ...
    \begin{longtable}[H]{|p{0.15\linewidth}|p{0.41\linewidth}|p{0.15\linewidth}|l|}
     ...
     \hline
     SP\spcount & The EVD updates personal data on its profile (such as email, payment) & EVD & eMall \\
     \hline
...
%TODO: keep the eMma and eMci or use only the given acronyms to simplify the reading?
