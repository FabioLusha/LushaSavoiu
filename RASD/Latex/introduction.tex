...
%TODO: rewrite the introduction, some changes occurred in the meanwhile, and a better explanation is needed, so everything is used in the following tables has to be understandable
%TODO: specify how the user interacts with the eMall through the mobile app, to make more clear the following notification part
%TODO: a descriptive introduction to the goals, referring to the two actors that use the system
