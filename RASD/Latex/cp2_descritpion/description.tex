...
\input{cp2_descritpion/01_product_perspective.tex}
...
\begin{table}[h!]
    ...
    \begin{tabular}{|l|p{0.725\linewidth}|}
     ...
     \hline
     A\acount & The DSOs use smart meters to detect interruptions and restore the supply of energy \\
     \hline
     A\acount & The CPO uses company credentials to access the CPMS \\
     \hline
\end{tabular}
    \caption{Assumptions}
