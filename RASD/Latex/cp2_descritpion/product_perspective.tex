...
%TODO TO@bianca
% checki if this description of the CPMS as a service is in accordance with you view
...
%TODO: TO@bianca
%BY@fabio 
% rephrasing of this paragraph
%Among the main interactions with the eMall we have decided to represent here with state diagrams the ones that we consider the most interesting and complex uses of the system, from the EVD point of view, namely: the initiation of a charging station and the booking operations.
...
\paragraph{Booking a charging socket}
...
\begin{itemize}
    ...
    %TODO i dond't like this phrase
