...
\begin{center}
    ...
    \hline
     ...
     Event flow &
        ...
        % TODO: @Bianca should we put a time limit on the possibility to book a charge %I think not, but did we wrote something about this in the precedent parts of the document?
     ...
     Event flow & 
        ...
        4. eMma shows a chronologically ordered list of all the previous charging sessions processed throught the system. Each element on the list contains details about:
            \begin{adjustwidth}{0.5cm}{}
                ...
                \end{itemize}
            \end{adjustwidth}
        %TODO: @Fabio do you agree with the filtering?
    ...
    \hline
     ...
     Event flow &   1. On the homepage the eMma shows the map of the territory, based on the location shared by the mobile phone of the EVD \newline
                    ...
                    \begin{adjustwidth}{0.5cm}{}
                        ...
                        \end{itemize}
                    \end{adjustwidth}
                    %shows the name of the charging station with the relative rating and reviews, the available chargers with their type of connectors, and the button 'Book now'
